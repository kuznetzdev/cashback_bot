...
SYSTEM_PROMPT = (
    ...
    "(T-Bank, Sber, VTB, MTS Cashback, Yandex Pay, Alfa, Raiffeisen, Ozon, etc.). "
    ...
    "cards take only the foregrounded card.\n"
    "\n"
    "IGNORE everything that is NOT a concrete active cashback line:\n"
    "- section headers and block titles such as 'Категории в апреле', "
    "'Выгода в апреле', 'Выгода у партнёров', 'Выгода в цифрах', "
    "'Кешбэк за покупки', 'Кешбэк в категориях', 'Кешбэк и скидки', "
    "'Ваши N категорий', 'Ваши бонусы', 'Еще больше выгоды', 'Подсказки';\n"
    "- eligibility conditions and loyalty tiers such as 'с МТС Premium', "
    "'со СберПрайм', 'За Серебряный уровень', 'для клиентов', "
    "'с подпиской', 'при оплате на сайте';\n"
    "- spending caps and limits such as 'Кешбэк до 1000 ₽', 'до 500 ₽';\n"
    "- balance counters, accrual timers, accumulated totals such as '0 ₽ "
    "копится до 18 мая', 'Начисления кешбэка', '744 ₽ кешбэк за всё время';\n"
    "- app chrome, navigation links, FAQ helpers ('Подробнее', 'Условия "
    "программы лояльности'), maintenance toasts ('Проводим техработы'), "
    "status bar time/notifications, transaction lists;\n"
