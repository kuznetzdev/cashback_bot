...
class Settings(BaseSettings):
    ...
    reminder_delivery_provider: str | None = Field(default=None, alias="REMINDER_DELIVERY_PROVIDER")
    ...
    app_enable_telegram: bool = Field(default=False, alias="APP_ENABLE_TELEGRAM")
    app_enable_web: bool = Field(default=True, alias="APP_ENABLE_WEB")
    web_enable_telegram_auth: bool = Field(default=False, alias="WEB_ENABLE_TELEGRAM_AUTH")
    ...
    web_session_secret: str = Field(default="dev-session-secret-not-for-production", alias="WEB_SESSION_SECRET")
